...
Route::group(['prefix'=>'front','namespace'=>'Front'],function(){
  ...
  Route::get('vendor/type','VendorTypesController@index')->name('vendor.types');

  Route::get('vendor/login/botique','VendorBotiqueController@showLoginForm')->name('vendor.login.botique');

  Route::post('vendor/login/botique','VendorBotiqueController@login')->name('vendor.login.botique.submit');

  Route::get('vendor/reg/botique','VendorBotiqueController@showRegForm')->name('vendor.reg.botique');
  
  Route::post('vendor/reg/botique','VendorBotiqueController@Register')->name('vendor.reg.botique.submit');

  Route::get('vendor/botique/logout','VendorBotiqueController@logout')->name('vendor.botique.logout');

  Route::get('vendor/login/food','VendorFoodController@showLoginForm')->name('vendor.login.food');

  Route::get('vendor/reg/food','VendorFoodController@showRegForm')->name('vendor.reg.food');


  Route::get('vendor/reg/service-provider','VendorServiceProviderController@showLoginForm')->name('vendor.reg.service-provider');

  Route::get('vendor/store/list','VendorController@storeList')->name('vendor.store.list');

  Route::get('vendor/store/{store_name}','VendorController@storeDetail')->name('vendor.store.detail');

  Route::get('get-searched-product/{store_name}/{cat_slug?}/{sub_cat?}/{child_cat?}','VendorController@getSearchedProduct')->name('get.searched.products');

   Route::get('get-filtered-product/','VendorController@getFilteredProduct')->name('get.filtered.products');

});



Route::get('get-state-list','Front\VendorBotiqueController@getStateList');
Route::get('get-city-list','Front\VendorBotiqueController@getCityList');

Route::get('vendor/get-state-list','Vendor\VendorController@getStateList');
Route::get('vendor/get-city-list','Vendor\VendorController@getCityList');
...
// ************************************ FRONT SECTION ENDS**********************************************
  ...
  Route::get('/addcart/{id}','Front\CartController@addcart')->name('product.cart.add');
  Route::get('/addtocart/{id}','Front\CartController@addtocart')->name('product.cart.quickadd');
  Route::get('/addnumcart','Front\CartController@addnumcart')->name('add.cart.qty');
  Route::get('/addbyone','Front\CartController@addbyone');
  Route::get('/reducebyone','Front\CartController@reducebyone');
  Route::get('/upcolor','Front\CartController@upcolor');
  Route::get('/removecart/{id}','Front\CartController@removecart')->name('product.cart.remove');
...
// CATEGORY SECTION
  ...
  //filter route
  Route::post('filter-products','Front\CatalogController@filter')->name('filter');
