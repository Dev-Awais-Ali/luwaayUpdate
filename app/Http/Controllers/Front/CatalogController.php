...
class CatalogController extends Controller
{
    ...
    {
        return view('front.shop-sidebar-without-banner');
    }
    ...
    public function category(Request $request, $slug=null, $slug1=null, $slug2=null)
    {
      ...
      return view('front.shop-sidebar-without-banner',compact('categories'), $data);
    }
    ...
    public function product($slug)
    {
        ...
        return view('front.product-default',compact('productt','curr','vendors'));
...
//        $product->update();
    ...
    // ------------------ Rating SECTION ENDS --------------------
        public function filter(Request $request){
          ...
          $max=explode('$',$max);
          $max=$max[1];
          $prods=Product::where('category_id',$category->id)->where('price','>=',$min)->where('price','<=',$max)->get();
          return view('front.shop-sidebar-without-banner',compact('prods','categories'));
        }
}
