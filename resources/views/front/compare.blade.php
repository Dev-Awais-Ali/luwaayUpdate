            ...
            <table class="table ps-table--compare">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="ps-product--compare">
                      <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('assets/front/img/products/electronic/3.jpg')}}" alt=""></a></div>
                      <div class="ps-product__content"><a href="product-default.html">Harman Kardon Onxy Studio 2.0 Wireless Bluetooth Speaker</a></div>
                    </div>
                  </td>
                  <td>
                    <div class="ps-product--compare">
                      <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('assets/front/img/products/electronic/8.jpg')}}" alt=""></a></div>
