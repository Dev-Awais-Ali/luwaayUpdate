    ...
    <div class="ps-breadcrumb">
      <div class="ps-container">
        <ul class="breadcrumb">
          ...
          <li>Magic Bullet NutriBullet Pro 900 Series Blender</li>
        </ul>
      </div>
    </div>
            ...
            <div class="ps-product--detail ps-product--fullwidth">
              <div class="ps-product__header">
                  ...
                  <figure>
                    <div class="ps-wrapper">
                      <div class="ps-product__gallery" data-arrow="true">
                        <div class="item"><a href="img/products/detail/out-stock/1.jpg"><img src="img/products/detail/out-stock/1.jpg" alt=""></a></div>
                        <div class="item"><a href="img/products/detail/out-stock/2.jpg"><img src="img/products/detail/out-stock/2.jpg" alt=""></a></div>
                        <div class="item"><a href="img/products/detail/out-stock/3.jpg"><img src="img/products/detail/out-stock/3.jpg" alt=""></a></div>
                        <div class="item"><a href="img/products/detail/out-stock/4.jpg"><img src="img/products/detail/out-stock/4.jpg" alt=""></a></div>
                      </div>
                    </div>
                  </figure>
                  <div class="ps-product__variants" data-item="4" data-md="4" data-sm="4" data-arrow="false">
                    <div class="item"><img src="img/products/detail/out-stock/1.jpg" alt=""></div>
                    <div class="item"><img src="img/products/detail/out-stock/2.jpg" alt=""></div>
                    <div class="item"><img src="img/products/detail/out-stock/3.jpg" alt=""></div>
                    <div class="item"><img src="img/products/detail/out-stock/4.jpg" alt=""></div>
                  </div>
                </div>
                <div class="ps-product__info">
                  ...
                  <h4 class="ps-product__price">$92.33</h4>
                  <div class="ps-product__desc">
                    <p>Sold By:<a class="mr-20" href="shop-default.html"><strong>  Globle Office</strong></a>Status:<a href="shop-default.html"><strong class="ps-tag--out-stock"> Out of stock</strong></a></p>
