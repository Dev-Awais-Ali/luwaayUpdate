...
<div class="ps-page--my-account">
    ...
    <div class="ps-my-account">
        <div class="container">
            <form style="max-width: 430px !important" class="ps-form--account ps-tab-root" action="link.html" method="get">
                ...
                <div class="ps-tabs">
                    <div class="ps-tab active" id="sign-in">
                        <div class="ps-form__content" style="padding-bottom: 30px">
                            ...
                            <p><span><strong>Don't Have an account! </strong><a href="{{route('vendor.reg.food')}}"> Sign Up Now</a></span></p>
                        </div>
