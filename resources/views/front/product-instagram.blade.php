    ...
    <div class="ps-breadcrumb">
      <div class="ps-container">
        <ul class="breadcrumb">
          ...
          <li>Unero Military Classical Backpack</li>
        </ul>
      </div>
    </div>
                  ...
                  <figure>
                    <div class="ps-wrapper">
                      <div class="ps-product__gallery" data-arrow="true">
                        <div class="item"><a href="img/products/detail/instagram/1.jpg"><img src="img/products/detail/instagram/1.jpg" alt=""></a></div>
                        <div class="item"><a href="img/products/detail/instagram/2.jpg"><img src="img/products/detail/instagram/2.jpg" alt=""></a></div>
                        <div class="item"><a href="img/products/detail/instagram/3.jpg"><img src="img/products/detail/instagram/3.jpg" alt=""></a></div>
                        <div class="item"><a href="img/products/detail/instagram/4.jpg"><img src="img/products/detail/instagram/4.jpg" alt=""></a></div>
                      </div>
                    </div>
                  </figure>
                  <div class="ps-product__variants" data-item="4" data-md="4" data-sm="4" data-arrow="false">
                    <div class="item"><img src="img/products/detail/instagram/1.jpg" alt=""></div>
                    <div class="item"><img src="img/products/detail/instagram/2.jpg" alt=""></div>
                    <div class="item"><img src="img/products/detail/instagram/3.jpg" alt=""></div>
                    <div class="item"><img src="img/products/detail/instagram/4.jpg" alt=""></div>
                  </div>
                </div>
                <div class="ps-product__info">
                  <h1>Unero Military Classical Backpack</h1>
                  ...
                  <h4 class="ps-product__price sale">$35.78
                    <del>$42.22</del><small> (-16%)</small>
                  </h4>
                  <div class="ps-product__desc">
                    <p>Sold By:<a class="mr-20" href="shop-default.html"><strong> Go Pro</strong></a>Status:<a class="mr-20" href="shop-default.html"><span class="ps-tag--in-stock">In-stock</span></a></p>
                    ...
                    <div class="ps-block__items">
                      <div class="ps-block__item">
                        <div class="ps-product ps-product--simple">
                          <div class="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/furniture/12.jpg" alt=""></a>
                      ...
                      <div class="ps-block__item">
                        <div class="ps-product ps-product--simple">
                          <div class="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/furniture/13.jpg" alt=""></a>
                            <ul class="ps-product__actions">
                              <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                              <li><a href="#" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="icon-eye"></i></a></li>
                              <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                      ...
                      <div class="ps-block__item ps-block__total">
                        <p>Total Price:<strong> $1000.30</strong></p><a class="ps-btn" href="#">Add All to cart</a><a class="ps-btn ps-btn--gray ps-btn--outline" href="#">Add All to whishlist</a>
                      </div>
                    </div>
