    ...
    <div class="ps-breadcrumb">
      <div class="ps-container">
        <ul class="breadcrumb">
          ...
          <li><a href="shop-default.html">Home Theater System</a></li>
          <li>Edifier Powered Bookshelf Speakers</li>
        </ul>
      </div>
    </div>
                  ...
                  <figure>
                    <div class="ps-wrapper">
                      <div class="ps-product__gallery" data-arrow="true">
                        <div class="item"><a href="img/products/detail/groupped/1.jpg"><img src="img/products/detail/groupped/1.jpg" alt=""></a></div>
                        <div class="item"><a href="img/products/detail/groupped/2.jpg"><img src="img/products/detail/groupped/2.jpg" alt=""></a></div>
                        <div class="item"><a href="img/products/detail/groupped/3.jpg"><img src="img/products/detail/groupped/3.jpg" alt=""></a></div>
                        <div class="item"><a href="img/products/detail/groupped/4.jpg"><img src="img/products/detail/groupped/4.jpg" alt=""></a></div>
                      </div>
                    </div>
                  </figure>
                  <div class="ps-product__variants" data-item="4" data-md="4" data-sm="4" data-arrow="false">
                    <div class="item"><img src="img/products/detail/groupped/1.jpg" alt=""></div>
                    <div class="item"><img src="img/products/detail/groupped/2.jpg" alt=""></div>
                    <div class="item"><img src="img/products/detail/groupped/3.jpg" alt=""></div>
                    <div class="item"><img src="img/products/detail/groupped/4.jpg" alt=""></div>
                  </div>
                </div>
                <div class="ps-product__info">
                  <h1>Edifier Powered Bookshelf Speakers</h1>
                  ...
                  <h4 class="ps-product__price">$85.62 – $320.54</h4>
                  <div class="ps-product__desc">
                    <p>Sold By:<a href="shop-default.html"><strong> Global Office</strong></a></p>
                  ...
                  <div class="ps-product__groupped">
                    <div class="table-responsive">
                      <table class="table ps-table--product-groupped">
                        <tbody>
                          <tr>
                            <td><a class="ps-btn" href="#">Read more</a></td>
                            <td><a class="title" href="product-default.html">Aroma Rice Cooker</a></td>
                            <td>
                              <p>$275.50</p>
                              <p>Status:<span class="ps-tag--out-stock"> Out of stock</span></p>
                            </td>
                          </tr>
                          <tr>
                            <td><a class="ps-btn" href="#">Read more</a></td>
                            <td><a class="title" href="product-default.html">Korea Fabric Chair In Brown Color</a></td>
                            <td>
                              <p> $320.54</p>
                              <p>Status:<span class="ps-tag--out-stock"> Out of stock</span></p>
                            </td>
                          ...
                          <tr>
                            <td><a class="ps-btn" href="#">Read more</a></td>
                            <td><a class="title" href="product-default.html">Set 14-Piece Knife From KichiKit</a></td>
                            <td>
                              <p>$85.62</p>
                              <p>Status:<span class="ps-tag--out-stock"> Out of stock</span></p>
                            </td>
