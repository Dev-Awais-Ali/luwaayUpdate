      ...
      <div class="ps-container">
        <div class="ps-page__container">
            ...
            <div class="ps-product--detail ps-product--fullwidth">
              <div class="ps-product__header">
                  ...
                  <figure>
                    <div class="ps-wrapper">
                      <div class="ps-product__gallery" data-arrow="true">
                        <div class="item"><a href="img/products/detail/affiliate/1.jpg"><img src="{{asset('assets/front/img/products/detail/affiliate/1.jpg')}}" alt=""></a></div>
                        <div class="item"><a href="img/products/detail/affiliate/2.jpg"><img src="{{asset('assets/front/img/products/detail/affiliate/2.jpg')}}" alt=""></a></div>
                        <div class="item"><a href="img/products/detail/affiliate/3.jpg"><img src="{{asset('assets/front/img/products/detail/affiliate/3.jpg')}}" alt=""></a></div>
                      </div>
                    </div>
                  </figure>
                  <div class="ps-product__variants" data-item="4" data-md="4" data-sm="4" data-arrow="false">
                    <div class="item"><img src="{{asset('assets/front/img/products/detail/affiliate/1.jpg')}}" alt=""></div>
                    <div class="item"><img src="{{asset('assets/front/img/products/detail/affiliate/2.jpg')}}" alt=""></div>
                    <div class="item"><img src="{{asset('assets/front/img/products/detail/affiliate/3.jpg')}}" alt=""></div>
                  </div>
                </div>
                <div class="ps-product__info">
                  ...
                  <div class="ps-product__shopping"><a class="ps-btn" href="#">Purchase on Amazon</a>
                ...
                <div class="ps-tabs">
                  <div class="ps-tab active" id="tab-1">
                    <div class="ps-document">
                      ...
                      <p>Weighing in under 7 pounds, the Kilburn is a lightweight piece of vintage styled engineering. Setting the bar as one of the loudest speakers in its class, the Kilburn is a compact, stout-hearted hero with a well-balanced audio which boasts a clear midrange and extended highs for a sound that is both articulate and pronounced. The analogue knobs allow you to fine tune the controls to your personal preferences while the guitar-influenced leather strap enables easy and stylish travel.</p><img class="mb-30" src="{{asset('assets/front/img/products/detail/content/description.jpg')}}" alt="">
          ...
          <div class="ps-page__right">
            ...
            <aside class="widget widget_ads"><a href="#"><img src="{{asset('assets/front/img/ads/product-ads.png')}}" alt=""></a></aside>
        ...
        <div class="ps-section--default ps-instagrams">
          ...
          <div class="ps-section__content">
            <div class="ps-carousel--nav owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="10" data-owl-nav="true" data-owl-dots="true" data-owl-item="7" data-owl-item-xs="3" data-owl-item-sm="4" data-owl-item-md="5" data-owl-item-lg="6" data-owl-duration="1000" data-owl-mousedrag="on"><a class="ps-block--instagram" href="#"><img src="{{asset('assets/front/img/instagram/1.jpg')}}" alt=""></a><a class="ps-block--instagram" href="#"><img src="{{asset('assets/front/img/instagram/2.jpg')}}" alt=""></a><a class="ps-block--instagram" href="#"><img src="{{asset('assets/front/img/instagram/3.jpg')}}" alt=""></a><a class="ps-block--instagram" href="#"><img src="{{asset('assets/front/img/instagram/4.jpg')}}" alt=""></a><a class="ps-block--instagram" href="#"><img src="{{asset('assets/front/img/instagram/5.jpg')}}" alt=""></a><a class="ps-block--instagram" href="#"><img src="{{asset('assets/front/img/instagram/5.jpg')}}" alt=""></a><a class="ps-block--instagram" href="#"><img src="{{asset('assets/front/img/instagram/7.jpg')}}" alt=""></a><a class="ps-block--instagram" href="#"><img src="{{asset('assets/front/img/instagram/8.jpg')}}" alt=""></a></div>
          </div>
        </div>
