								...
								<ul class="list">
									...
									<li class="bell-area">
										<a id="notf_order" class="dropdown-toggle-1" href="javascript:;">
											...
											<span data-href="{{ route('vendor-order-notf-count',Auth::guard('vendor_botique')->user()->id) }}" id="order-notf-count">{{ App\Models\UserNotification::countOrder(Auth::guard('vendor_botique')->user()->id) }}</span>
										</a>
										<div class="dropdown-menu">
											<div class="dropdownmenu-wrapper" data-href="{{ route('vendor-order-notf-show',Auth::guard('vendor_botique')->user()->id) }}" id="order-notf-show">
										</div>
										</div>
									</li>
											...
											<div class="dropdownmenu-wrapper">
													<ul>
														<h5>{{ $langg->lang431 }}</h5>
															...
															<li>
																<a target="_blank" href="#"><i class="fas fa-eye"></i> {{ $langg->lang432 }}</a>
															</li>

															<li>
																<a href="#"><i class="fas fa-sign-in-alt"></i> {{ $langg->lang433 }}</a>
															</li>
															...
															<li>
																<a href="{{ route('vendor.botique.logout') }}"><i class="fas fa-power-off"></i> {{ $langg->lang435 }}</a>
															</li>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a target="_blank" href="#" class="wave-effect active"><i class="fas fa-eye mr-2"></i> {{ $langg->lang440 }}</a>
							</li>

							<li>
								<a href="#" class="wave-effect active"><i class="fa fa-home mr-2"></i>{{ $langg->lang441 }}</a>
							</li>
							<li>
